...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex justify-between items-center px-6 sm:px-12 py-4  dark:bg-zinc-900 shadow-sm border-b dark:border-zinc-800 backdrop-blur-2xl fixed" >
      {/* Logo */}
